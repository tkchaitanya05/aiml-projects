...
def main():
    ...
    for i, xml_file in enumerate(xml_files):
        ...
        xmin = float(tree.findtext("./object/bndbox/xmin"))
        ymin = float(tree.findtext("./object/bndbox/ymin"))
        xmax = float(tree.findtext("./object/bndbox/xmax"))
        ymax = float(tree.findtext("./object/bndbox/ymax"))
